...
# Form implementation generated from reading ui file 'C:\Users\vieta\OneDrive\Documents\mangareader\mangareader_oasis.ui'
#
...
" }"))
        ...
        self.stackedwidget.setGeometry(QtCore.QRect(0, 0, 1261, 1531))
        ...
        self.bg1.setGeometry(QtCore.QRect(0, 0, 1261, 1531))
...
"}"))
        ...
        self.image.setGeometry(QtCore.QRect(0, 0, 1261, 1501))
        ...
        self.dockbar.setGeometry(QtCore.QRect(0, 0, 1261, 101))
...
"}"))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(2, 2, 1261, 102))
        ...
        self.pagedock.setGeometry(QtCore.QRect(0, 1390, 1261, 91))
        self.pagedock.setObjectName(_fromUtf8("pagedock"))
        self.widget_2 = QtGui.QWidget(self.pagedock)
        self.widget_2.setGeometry(QtCore.QRect(0, 0, 1261, 91))
...
"}"))
        ...
        self.pageslider.setGeometry(QtCore.QRect(320, 30, 891, 21))
...
"}"))
        ...
        self.searchButton.setGeometry(QtCore.QRect(540, 190, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(8)
...
"}"))
        ...
        self.mangaSearch.setGeometry(QtCore.QRect(20, 120, 1231, 61))
        font = QtGui.QFont()
        ...
        self.widget_3.setGeometry(QtCore.QRect(1, 1, 1251, 101))
...
"}"))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(0, 0, 1251, 102))
...
"}"))
        ...
        self.widget.setGeometry(QtCore.QRect(0, 1100, 1261, 391))
...
"}"))
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(0, 10, 1261, 381))
        ...
        self.comicselector.setGeometry(QtCore.QRect(960, 190, 251, 41))
...
"}"))
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(0, 0, 1261, 82))
...
"}"))
        ...
        self.infoimage = QtGui.QLabel(self.bg3)
        self.infoimage.setGeometry(QtCore.QRect(1020, 100, 231, 301))
...
"}"))
        ...
        self.widget_5.setGeometry(QtCore.QRect(1, 0, 1261, 81))
...
"}"))
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(-2, 0, 1261, 82))
        ...
        self.bookmarklist.setGeometry(QtCore.QRect(0, 140, 1261, 1361))
        ...
        self.no_bookmark.setGeometry(QtCore.QRect(10, 150, 1241, 171))
        font = QtGui.QFont()
        font.setPointSize(12)
...
"}"))
        ...
        self.brightness_window.setGeometry(QtCore.QRect(100, 350, 1050, 311))
